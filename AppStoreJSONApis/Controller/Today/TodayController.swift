...
class TodayController: BaseListController, UICollectionViewDelegateFlowLayout {
    ...
    fileprivate func fetchData() {
        ...
        dispatchGroup.notify(queue: .main) {
            ...
            self.items = [
                ...
                TodayItem.init(category: "HOLIDAYS", title: "Travel on a Budget", image: #imageLiteral(resourceName: "holiday"), description: "Find out all you need to know on how to travel without packing everything!", backgroundColor: #colorLiteral(red: 0.9827767015, green: 0.9663359523, blue: 0.721589148, alpha: 1), cellType: .single, apps: [])
            ]
    ...
    fileprivate func setupAppFullscreensStartingPosition(_ indexPath: IndexPath) {
    ...
    fileprivate func showSingleAppFullscreen(indexPath: IndexPath) {
        ...
        setupAppFullscreensStartingPosition(indexPath)
